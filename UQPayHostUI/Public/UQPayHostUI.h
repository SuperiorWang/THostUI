...
//! Project version number for UQPayHostUI.
FOUNDATION_EXPORT double UQPayHostUIVersionNumber;

//! Project version string for UQPayHostUI.
FOUNDATION_EXPORT const unsigned char UQPayHostUIVersionString[];
