...
@interface UQUIKFormField : UIView <UITextFieldDelegate, UIKeyInput>

/// The delegate for this form field
@property (nonatomic, weak) id<UQUIKFormFieldDelegate> delegate;
...
/// The text field
@property (nonatomic, strong) UQUIKTextField* textField;
/// The label
...
@protocol UQUIKFormFieldDelegate <NSObject>
...
- (BOOL)formFieldShouldReturn:(UQUIKFormField *)formField;
/// Did begin editing
- (void)formFieldDidBeginEditing:(UQUIKFormField *)formField;
/// Did end editing
